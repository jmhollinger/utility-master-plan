...
app.get('/ku', stormpath.groupsRequired(['KU', 'Admins'], false), function (req, res) {
  ...
  res.render('form', {"utility": "Kentucky Utilities", "user": req.user.givenName + ' ' + req.user.surname, 'user_f': req.user.givenName, 'email': req.user.email, 'phone': user_phone, 'streets' : streetnames });
});
...
app.get('/datalink', stormpath.groupsRequired(['DataLink', 'Admins'], false), function (req, res) {
  ...
  res.render('form', {"utility": "DataLink", "user": req.user.givenName + ' ' + req.user.surname, 'user_f': req.user.givenName, 'email': req.user.email, 'phone': user_phone, 'streets' : streetnames  });
});
...
app.get('/kywired', stormpath.groupsRequired(['KyWired', 'Admins'], false), function (req, res) {
  ...
  res.render('form', {"utility": "Kentucky Wired Network", "user": req.user.givenName + ' ' + req.user.surname, 'user_f': req.user.givenName, 'email': req.user.email, 'phone': user_phone, 'streets' : streetnames  });
});
...
app.get('/level3', stormpath.groupsRequired(['Level3', 'Admins'], false), function (req, res) {
  ...
  res.render('form', {"utility": "Level 3 Communications", "user": req.user.givenName + ' ' + req.user.surname, 'user_f': req.user.givenName, 'email': req.user.email, 'phone': user_phone, 'streets' : streetnames });
});
...
app.get('/lfucg-ss', stormpath.groupsRequired(['LFUCG-SS', 'Admins'], false), function (req, res) {
  ...
  res.render('form', {"utility": "LFUCG - Sanitary Sewers", "user": req.user.givenName + ' ' + req.user.surname, 'user_f': req.user.givenName, 'email': req.user.email, 'phone': user_phone, 'streets' : streetnames  });
});
...
app.get('/windstream', stormpath.groupsRequired(['Windstream', 'Admins'], false), function (req, res) {
  ...
  res.render('form', {"utility": "Windstream", "user": req.user.givenName + ' ' + req.user.surname, 'user_f': req.user.givenName, 'email': req.user.email, 'phone': user_phone, 'streets' : streetnames  });
});
...
app.get('/twc', stormpath.groupsRequired(['TWC', 'Admins'], false), function (req, res) {
  ...
  res.render('form', {"utility": "Time Warner", "user": req.user.givenName + ' ' + req.user.surname, 'user_f': req.user.givenName, 'email': req.user.email, 'phone': user_phone, 'streets' : streetnames  });
});
...
app.get('/crowncastle', stormpath.groupsRequired(['CrownCastle', 'Admins'], false), function (req, res) {
  ...
  res.render('form', {"utility": "Crown Castle", "user": req.user.givenName + ' ' + req.user.surname, 'user_f': req.user.givenName, 'email': req.user.email, 'phone': user_phone, 'streets' : streetnames });
});
...
app.get('/delta', stormpath.groupsRequired(['Delta', 'Admins'], false), function (req, res) {
  ...
  res.render('form', {"utility": "Delta Gas", "user": req.user.givenName + ' ' + req.user.surname, 'user_f': req.user.givenName, 'email': req.user.email, 'phone': user_phone, 'streets' : streetnames });
});
...
app.get('/other', stormpath.groupsRequired(['Other', 'Admins'], false), function (req, res) {
  ...
  res.render('form', {"utility": "", "user": req.user.givenName + ' ' + req.user.surname, 'user_f': req.user.givenName, 'email': req.user.email, 'phone': user_phone, 'streets' : streetnames });
});
