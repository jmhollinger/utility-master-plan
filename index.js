...
app.get('/level3', stormpath.groupsRequired(['Level3', 'Admins'], false), function (req, res) {
  res.render('form', {"utility": "Level 3 Communications", "user": req.user.givenName + ' ' + req.user.surname, 'user_f': req.user.givenName, 'email': req.user.email, 'phone' : req.customData.phone });
});
